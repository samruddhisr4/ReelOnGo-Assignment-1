...
const lanterns = [
    ...
    { id: 23, left: "41%", top: "8%", width: "3.5%", animDelay: "1.3s", animDur: "5.8s", rotate: "7deg" },
    ...
    { id: 13, left: "90%", top: "5.6%", width: "5.5%", animDelay: "2.8s", animDur: "5s", rotate: "-3deg" },
    ...
    { id: 19, left: "63%", top: "7%", width: "5%", animDelay: "1.5s", animDur: "4.4s", rotate: "-5deg" },
                    ...
                    <div className="absolute top-0 left-0 w-full flex flex-col items-center pt-8 px-4 z-10">
                        ...
                        <div className="relative z-10 text-center flex flex-col items-center">
                            ...
                            <h1
                                ...
                                style={{ paddingTop: "13%", fontFamily: "Castellar", textShadow: "0 2px 20px rgba(0,0,0,0.7)" }}
                            >
                                MEENAYA
                            </h1>
                        ...
                        <img src="/ganpati.avif" alt="" style={{ position: "absolute", top: "760%", left: "50%", transform: "translate(-50%, -50%)", width: "10%", height: "auto" }} />

                        <div style={{ position: "absolute", top: "920%", left: "50%", transform: "translate(-50%, -50%)", width: "90%", maxWidth: "800px", textAlign: "center", display: "flex", flexDirection: "col", alignItems: "center", justifyContent: "center" }}>
                            <div className="flex flex-col items-center justify-center w-full">
                                <p style={{ color: "#F3ECBA", fontFamily: "'Noto Serif Devanagari','Noto Serif',serif", fontSize: "clamp(1rem,2.5vw,1.4rem)", margin: "0 0 1.5rem" }}>
                                    ॐ श्री गणेशाय नमः
                                </p>
                                ...
                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(1.2rem,2.8vw,1.6rem)", color: "#F3ECBA", fontWeight: 600, lineHeight: 1.4, margin: "0 0 2.5rem" }}>
                                    Smt. Kamakshi Ammal &amp;<br />Shri Srinivasan Iyer
                                </p>

                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(1.5rem,3.5vw,2.2rem)", fontWeight: 700, color: "#F3ECBA", letterSpacing: "0.3em", margin: "0 0 1.5rem", textTransform: "uppercase" }}>
                                    INVITE
                                </p>

                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(1rem,2vw,1.3rem)", color: "#F3ECBA", fontStyle: "italic", margin: "0 0 2rem" }}>
                                    You to join us in the wedding celebrations of
                                </p>

                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(2.5rem,6vw,4rem)", fontWeight: 700, color: "#F3ECBA", lineHeight: 1.1, margin: "0" }}>
                                    Vishu
                                </p>

                                <p style={{ fontFamily: "'Cormorant Upright',Georgia,serif", fontSize: "clamp(1.5rem,4vw,2.5rem)", color: "#F3ECBA", fontStyle: "italic", lineHeight: 1.1, margin: "1rem 0" }}>
                                    &amp;
                                </p>

                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(2.5rem,6vw,4rem)", fontWeight: 700, color: "#F3ECBA", lineHeight: 1.1, margin: "0 0 1.5rem" }}>
                                    Kavya
                                </p>

                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(0.9rem,1.8vw,1.2rem)", color: "#F3ECBA", fontStyle: "italic", margin: "0 0 0.5rem" }}>
                                    Daughter of
                                </p>
                                <p style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(1.1rem,2.5vw,1.5rem)", color: "#F3ECBA", fontWeight: 600, lineHeight: 1.4, margin: "0" }}>
