...
//     const showPlacard = placard !== "-NoSelection-";
//     return (
//         <div className="relative w-full" style={{ minHeight: "300vh", backgroundColor: "#f9efa7" }}>
//             {/* 1. Background Layer (fills the section) */}
...
//             <div className="relative z-20 w-full flex flex-col items-center px-4 md:px-20 text-[#7b7037] pt-[19%]" style={{ paddingBottom: "120vh" }}>
...
const byPrefixAndName = {
    fab: { instagram: faInstagram },
    fas: { 'sun-bright': faSun, car: faCar },
    fass: { 'people-line': faPeopleLine }
};

export default function CarSection({ placard = "-NoSelection-" }: { placard?: string }) {
    const showPlacard = placard !== "-NoSelection-";
    return (
        // ✅ FIX: Removed minHeight:"300vh" and paddingBottom:"120vh" — these were
        // creating the huge black void on mobile. Content height drives the section now.
        // ✅ FIX: Added a z-index to the parent container so its child (the car)
        // can overlap the next section (CountdownSection).
        <div className="relative w-full overflow-hidden z-20">
            ...
            {/* Main Content */}
            <div className="relative z-20 w-full flex flex-col items-center px-4 md:px-20 text-[#7b7037]"
                style={{
                    // ✅ FIX: was pt-[19%] which is huge on mobile. Use clamp instead.
                    paddingTop: "clamp(3rem, 8vw, 7rem)",
                    // ✅ FIX: was paddingBottom:"120vh" — replaced with reasonable spacing
                ...
                <h2
                    className="tracking-[0.3em] font-bold text-center"
                    style={{ fontFamily: "Castellar, serif", fontSize: "clamp(1.8rem, 6vw, 4.5rem)", marginBottom: "clamp(1rem, 4vw, 3rem)" }}
                >
                    THINGS TO KNOW
                </h2>

                <p
                    className="italic text-center max-w-4xl opacity-90"
                    style={{
                ...
                {/* ✅ FIX: On mobile, grid-cols-1 stacks cards. gap is also responsive. */}
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 w-full max-w-7xl"
                    style={{ gap: "clamp(1.5rem, 4vw, 3rem)", paddingTop: "clamp(0.5rem, 2vw, 2rem)" }}>

                    {/* Hashtag */}
                    <div className="flex flex-col items-center text-center px-4">
                        <div className="mb-6 flex items-center justify-center opacity-70">
                            <FontAwesomeIcon icon={byPrefixAndName.fab['instagram']} style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)" }} />
                        </div>
                        <h3 className="tracking-[0.2em] font-bold mb-3" style={{ fontFamily: "Castellar, serif", fontSize: "clamp(1rem, 2.5vw, 1.4rem)" }}>HASHTAG</h3>
                        <p className="opacity-75 leading-relaxed" style={{ fontFamily: "Georgia, serif", fontSize: "clamp(0.8rem, 2vw, 0.95rem)" }}>
                    ...
                    <div className="flex flex-col items-center text-center px-4">
                        <div className="mb-6 flex items-center justify-center opacity-70">
                            <FontAwesomeIcon icon={byPrefixAndName.fas['sun-bright']} style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)" }} />
                        </div>
                        <h3 className="tracking-[0.2em] font-bold mb-3" style={{ fontFamily: "Castellar, serif", fontSize: "clamp(1rem, 2.5vw, 1.4rem)" }}>WEATHER</h3>
                        <p className="opacity-75 leading-relaxed" style={{ fontFamily: "Georgia, serif", fontSize: "clamp(0.8rem, 2vw, 0.95rem)" }}>
                            It will be mostly sunny with temperature reaching up to 28 degrees at the venue.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center px-4">
                        <div className="mb-6 flex items-center justify-center opacity-70">
                            <FontAwesomeIcon icon={byPrefixAndName.fass['people-line']} style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)" }} />
                        </div>
                        <h3 className="tracking-[0.2em] font-bold mb-3" style={{ fontFamily: "Castellar, serif", fontSize: "clamp(1rem, 2.5vw, 1.4rem)" }}>STAFF</h3>
                        <p className="opacity-75 leading-relaxed" style={{ fontFamily: "Georgia, serif", fontSize: "clamp(0.8rem, 2vw, 0.95rem)" }}>
                            We recommend the nearby hotel called Bhola Bhawan near the venue for the staff members.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col items-center text-center px-4">
                        <div className="mb-6 flex items-center justify-center opacity-70">
                            <FontAwesomeIcon icon={byPrefixAndName.fas['car']} style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)" }} />
                        </div>
                        <h3 className="tracking-[0.2em] font-bold mb-3" style={{ fontFamily: "Castellar, serif", fontSize: "clamp(1rem, 2.5vw, 1.4rem)" }}>PARKING</h3>
                        <p className="opacity-75 leading-relaxed" style={{ fontFamily: "Georgia, serif", fontSize: "clamp(0.8rem, 2vw, 0.95rem)" }}>
                ...
                {/* FOLLOW OUR ACTIONS */}
                <div className="flex flex-col items-center w-full" style={{ marginTop: "clamp(3rem, 8vw, 6rem)" }}>
                    <h2
                        className="text-[#7b7037] font-bold tracking-[0.3em] text-center"
                        style={{ fontFamily: "Castellar, serif", fontSize: "clamp(1.6rem, 6vw, 5rem)", marginBottom: "clamp(0.5rem, 2vw, 1rem)" }}
                    >
                        FOLLOW OUR ACTIONS
                    </h2>
                    <p
                        className="text-[#7b7037] italic text-center opacity-80"
                    ...
                    <div className="relative group flex flex-col items-center">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-24 h-24 rounded-full border-[4px] border-[#7b7037]/30 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:border-[#7b7037] relative cursor-pointer"
                        >
                            <div className="absolute inset-0 rounded-full border-2 border-[#7b7037]/20 animate-ping" />
                            <div className="w-14 h-14 flex items-center justify-center">
                                <div className="w-6 h-6 rounded-full bg-[#7b7037]" />
            ...
            {/* ✅ FIX: Car2 was using bottom:"15vh" + transform:"translate(-50%, 50%)" which
                pushed it far out of bounds on mobile. Now uses relative flow like CoupleSection car. */}
            {/* ✅ FIX: Car2 was being clipped. Removed negative marginBottom and 
                ensured it has a high z-index to stay visible during transition. */}
            <div className="relative w-full flex justify-center align-end z-[50]"
                style={{ marginTop: "5%" }}>
                <img
                    src="/car2.avif"
                    alt="Transition Car Bottom"
